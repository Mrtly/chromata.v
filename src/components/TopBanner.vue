<template>
  <div class="min-h-[100px] py-4 px-3 lg:px-8 bg-slate-900 text-white">
      ...
      <router-link :to="{name: 'Home'}">
          <div class="w-max p-2 flex items-center border border-transparent hover:border-slate-700">
            ...
            <div class="ml-3">
              ...
              <span class="font-thin text-slate-400">with thecolorapi</span>
            </div>
        </div>
      </router-link>
      <div class="flex items-center">
        <span class="hidden lg:block">
          <router-link class="underline text-slate-400 hover:text-slate-300" :to="{name: 'Home'}">home</router-link>
